...
// Detail-screen timeline synthesis (endpoint stand-in). The endpoint
// interleaves synthesized run-state events (renewal, cancellation, missed,
// ended, gap) with charge rows by date; the client renders the result.
